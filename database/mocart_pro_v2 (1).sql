...
CREATE TABLE `orders` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `receiver_name` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `receiver_phone` varchar(20) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `address_line` mediumtext COLLATE utf8mb4_vietnamese_ci,
...
CREATE TABLE `order_items` (
  ...
  `sku` varchar(100) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
...
(1, 1, NULL, NULL, 'SKU-1', '1111111.00', '850.00', 76, '2026-01-13 08:58:09', '2026-02-05 13:19:29'),
(2, 2, NULL, NULL, 'SKU-2', '1000.00', '850.00', 99, '2026-01-13 08:58:09', '2026-02-05 13:07:28'),
(3, 6, NULL, NULL, 'SKU-6', '1000.00', '850.00', 97, '2026-01-13 08:58:09', '2026-02-04 17:00:50'),
...
(4, 1, 'Đỗ Minh Đăng', '0982563450', '3333 Hà Thị Khiêm', NULL, NULL, NULL, 0),
(5, 1, 'Đỗ Minh Đăng', '0982563450', 'FPT5', NULL, NULL, NULL, 0);
