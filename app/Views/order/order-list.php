                                                    ...
                                                    <td>
                                                        <div class="user-action-dropdown dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" href="<?= BASE_URL ?>order/detail"><i class="far fa-eye"></i> Chi tiết đơn hàng</a></li>
                                                                <li><a class="dropdown-item" href="#"><i class="far fa-pen-swirl"></i> Đang chờ</a></li>
                                                                <li><a class="dropdown-item" href="#"><i class="far fa-circle-dashed"></i> Đang xử lý</a></li>
                                                                <li><a class="dropdown-item" href="#"><i class="far fa-check-circle"></i> Hoàn thành</a></li>
                                                                <li><a class="dropdown-item" href="#"><i class="far fa-xmark-circle"></i> Hủy</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
